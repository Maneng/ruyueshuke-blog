---
title: "约束与完整性：主键、外键、唯一、非空"
date: 2025-11-21T13:00:00+08:00
draft: false
tags: ["MySQL", "约束", "数据完整性", "基础入门"]
categories: ["技术"]
description: "理解数据库约束的作用，掌握主键、外键、唯一约束、非空约束的使用，保证数据完整性"
series: ["MySQL从入门到精通"]
weight: 7
stage: 1
stageTitle: "基础入门篇"
...
1. [MySQL官方文档 - 约束](https://dev.mysql.com/doc/refman/8.0/en/constraints.html)
2. [MySQL官方文档 - 外键](https://dev.mysql.com/doc/refman/8.0/en/create-table-foreign-keys.html)
