...
stage: 4
stageTitle: "进阶特性篇"
description: "学习Sentinel的系统自适应保护机制，从Load、CPU、RT等多维度全面保护系统"
---

## 引言：当整个系统都在危险边缘

在前面的文章中，我们学习了**限流**和**熔断**，它们都是针对**单个资源**的保护：
- 限流：保护单个接口不被流量压垮
- 熔断：保护自己不被依赖服务拖垮
